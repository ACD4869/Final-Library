...
public class Sequence_Member_Id {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sequence member Id is "+obj_Sequence_Member_Id.get_member_id());
	...
	public String get_member_id(){
		...
		String sequence_id="";
		String query="select id_no from sequence_member_id";
		try {
			...
			query="update sequence_member_id set id_no=id_no+1 where id_no=?";
			ps=connection.prepareStatement(query);
			ps.setInt(1, id_no+0);
			//ps.setInt(2, id_no);
	...
	public  void create_table(){
		...
		String query="create table sequence_member_id(id_no int(255) not null,primary key(id_no))";
		try {
			ps=connection.prepareStatement(query);
			ps.executeUpdate();
			
	        query="insert into sequence_member_id values(1)";
			ps=connection.prepareStatement(query);
