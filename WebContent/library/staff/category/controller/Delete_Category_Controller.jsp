...
<jsp:useBean id="obj_Category_Use_Bean" class="common_use_bean.Category_Use_Bean"></jsp:useBean>
	...
	Category_Table obj_Category_Table=new Category_Table();
	   ...
	   int flag=obj_Category_Table.delete_category(obj_Category_Use_Bean);
	   
	   if(flag==1){
		   
			
			session.setAttribute("add_category_message","Deleted Successfully");
		...
		%>
		  		 ...
		  		 <script type="text/javascript">
						window.location.href="<%=Common_Things.url%>/staff-add-category";
				</script>
