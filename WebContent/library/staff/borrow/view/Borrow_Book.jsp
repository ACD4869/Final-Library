...
<body>
    <div class="app" data-sidebar="locked">
         <%@include file="../../common/tab.jsp" %>
			...
			Copy_Table_Model obj_Inventry_Table_Model=new Copy_Table_Model();
            ...
            <section class="main-content">
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6"> 
                            <h3 class="no-margin">Borrow Book: <%=obj_Book_Use_Bean.getBook_title() %></h3>
							...
							%>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/borrow-book-controller/" class="form-horizontal" role="form" method="post" name="myForm"  onsubmit="return validateForm()">
                                                    
                                                    	<input type="hidden" name="book_sl_no" value="<%=obj_Book_Use_Bean.getBook_id_no() %>">
                                                     ...
                                                     <hr> 
                                                         <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Member ID</label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="member_id" id="search" data-parsley-required="true" data-parsley-trigger="change" placeholder="Member Admission No">
                                                               </div> 
