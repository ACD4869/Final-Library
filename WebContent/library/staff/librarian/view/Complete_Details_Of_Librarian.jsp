							...
							%>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/add-librarian-controller/" class="form-horizontal" role="form">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Librarian ID</label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="librarian_id" data-parsley-required="true" data-parsley-trigger="change" placeholder="Librarian ID" value="<%if(obj_Librarian_Use_Bean.getLibrarian_id()!=null){out.println(obj_Librarian_Use_Bean.getLibrarian_id());} %>" readonly="readonly">
                                                               </div> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Name" name="librarian_name" value="<%if(obj_Librarian_Use_Bean.getLibrarian_name()!=null){out.println(obj_Librarian_Use_Bean.getLibrarian_name());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Telephone" name="telephone" value="<%if(obj_Librarian_Use_Bean.getTelephone()!=null){out.println(obj_Librarian_Use_Bean.getTelephone());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="ID Number" name="number_id" value="<%if(obj_Librarian_Use_Bean.getNumber_id()!=null){out.println(obj_Librarian_Use_Bean.getNumber_id());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">  
                                                            <div class="col-sm-offset-2 col-sm-15">
                                                                ...
                                                                <a href="<%=Common_Things.url %>/edit-profile-librarian/?lm=<%=obj_Librarian_Use_Bean.getLibrarian_id() %>" class="btn btn-warning">Edit Profile</a>
