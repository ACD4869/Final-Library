...
<jsp:useBean id="obj_Librarian_Use_Bean" class="common_use_bean.Librarian_Use_Bean"></jsp:useBean>
	...
	Librarian_Table_Model obj_Librarian_Table_Model=new Librarian_Table_Model();
	   ...
	   int flag=obj_Librarian_Table_Model.insert_librarian(obj_Librarian_Use_Bean);
	   
	   if(flag==1){
		   
			
			session.setAttribute("add_librarian_message","Librarian Added Successfully");
		...
		%>
		  		 ...
		  		 <script type="text/javascript">
						window.location.href="<%=Common_Things.url%>/add-librarian/";
				</script>
