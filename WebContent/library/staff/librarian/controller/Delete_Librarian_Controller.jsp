...
<%@page import="librarian_table.Librarian_Table_Model"%><html>
<head>
...
<jsp:useBean id="obj_Librarian_Use_Bean" class="common_use_bean.Librarian_Use_Bean"></jsp:useBean>
	...
	Librarian_Table_Model obj_Librarian_Table_Model=new Librarian_Table_Model();
	   ...
	   int flag=obj_Librarian_Table_Model.delete_librarian(obj_Librarian_Use_Bean);
	   
	   if(flag==1){
		   
			
			session.setAttribute("delete_librarian_message","Librarian Deleted Successfully");
		
	  	   
	   }else{

			 session.setAttribute("delete_librarian_message","Failed");
