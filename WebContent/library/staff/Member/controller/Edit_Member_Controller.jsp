...
<jsp:useBean id="obj_Member_Use_Bean" class="common_use_bean.Member_Use_Bean"></jsp:useBean>
	...
	Member_Table_Model obj_Member_Table_Model=new Member_Table_Model();
	   ...
	   int flag=obj_Member_Table_Model.edit_member(obj_Member_Use_Bean);
	   
	   if(flag==1){
		   
			
			session.setAttribute("add_member_message","Updated Successfully");
		
			
	   }else{

			 session.setAttribute("add_member_message","Failed");
		...
		%>
		  		 ...
		  		 <script type="text/javascript">
						window.location.href="<%=Common_Things.url%>/complete-details-member/?lm=<%=obj_Member_Use_Bean.getMember_id()%>";
				</script>
