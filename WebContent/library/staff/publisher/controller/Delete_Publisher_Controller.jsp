...
<jsp:useBean id="obj_Publisher_Use_Bean" class="common_use_bean.Publisher_Use_Bean"></jsp:useBean>
	...
	Publisher_Table obj_Publisher_Table=new Publisher_Table();
	   ...
	   int flag=obj_Publisher_Table.delete_publisher(obj_Publisher_Use_Bean);
	   
	   if(flag==1){
		   
			
			session.setAttribute("add_publisher_message","Deleted Successfully");
		...
		%>
		  		 ...
		  		 <script type="text/javascript">
						window.location.href="<%=Common_Things.url%>/staff-add-publisher";
				</script>
