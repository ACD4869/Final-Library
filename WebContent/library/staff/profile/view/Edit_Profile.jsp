...
<%@page import="staff_table.Staff_Profile_Model"%><html class="no-js">
        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6"> 
                            <h3 class="no-margin">Edit Staff</h3>
                    ...
                    <div class="col-lg-8">
                    	...
                    	obj_Staff_Use_Bean=obj_Staff_Profile_Model.get_staff_details(obj_Staff_Use_Bean);
                    	%>
                                            ...
                                            <section class="panel"> 
                                                <header class="panel-heading">Edit Staff Details</header>
                                                    ...
                                                    <form action="<%=Common_Things.url%>/edit-profile-controller/" class="form-horizontal" role="form" method="post">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">User Name</label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="admission_no" data-parsley-required="true" data-parsley-trigger="change" placeholder="User Name" value="<%if(obj_Staff_Use_Bean.getUser_name()!=null){out.println(obj_Staff_Use_Bean.getUser_name());} %>" readonly="readonly">
                                                               </div> 
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">New User Name</label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="user_name" data-parsley-required="true" data-parsley-trigger="change" placeholder="User Name" value="<%if(obj_Staff_Use_Bean.getUser_name()!=null){out.println(obj_Staff_Use_Bean.getUser_name());} %>">
                                                               </div> 
