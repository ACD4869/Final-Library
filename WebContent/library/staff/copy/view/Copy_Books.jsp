            ...
            <section class="main-content">
                <div class="content-wrap">
                    ...
                    <div class="col-lg-6">
							...
							Staff_Book_Table_Model obj_Admin_Book_Table_Model=new Staff_Book_Table_Model();
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <ul class="list-group">
                                	...
                                	<%
                               // 	Copy_Table_Model obj_Copy_Table_Model=new Copy_Table_Model();                                                                                                                               		//Admin_Book_Table_Model obj_Admin_Book_Table_Model=new Admin_Book_Table_Model(); 
