...
<jsp:useBean id="obj_Book_Use_Bean" class="common_use_bean.Book_Use_Bean"></jsp:useBean>
	...
	Copy_Table_Model obj_Copy_Table_Model=new Copy_Table_Model();
	   ...
	   int flag=obj_Copy_Table_Model.delete_serial(obj_Book_Use_Bean);
	   
	   if(flag==1){
		   
			
			session.setAttribute("add_copy_message","Deleted Successfully");
		
	   }else{

			 session.setAttribute("add_copy_message","Failed");
		...
		%>
		  		 ...
		  		 <script type="text/javascript">
						window.location.href="<%=Common_Things.url%>/copy-books/?kou=<%=obj_Book_Use_Bean.getBook_id_no()%>";
				</script>
