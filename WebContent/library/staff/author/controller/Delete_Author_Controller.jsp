...
<jsp:useBean id="obj_Author_Use_Bean" class="common_use_bean.Author_Use_Bean"></jsp:useBean>
	...
	<%
			Author_Table_Model obj_Author_Table_Model=new Author_Table_Model();
			   ...
			   int flag=obj_Author_Table_Model.delete_author(obj_Author_Use_Bean);
			   
			   if(flag==1){
				   
			
			session.setAttribute("add_author_message","Deleted Successfully");
				
			   }else{

			 session.setAttribute("add_author_message","Failed");
